...
export default function Button({ 
  ...
  const variantClasses = {
    primary: 'bg-teal-600 hover:bg-teal-700 from-neutral-700 to-neutral-800 hover:from-neutral-600 hover:to-neutral-700 disabled:from-neutral-800 disabled:to-neutral-900 text-neutral-100 hover:shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed',
